...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = strprintf("%s huntercoin-tx utility version", PACKAGE_NAME) + " " + FormatFullVersion() + "\n\n" +
            "Usage:\n"
              "  huntercoin-tx [options] <hex-tx> [commands]  Update hex-encoded huntercoin transaction\n" +
              "  huntercoin-tx [options] -create [commands]   Create hex-encoded huntercoin transaction\n" +
              "\n";
