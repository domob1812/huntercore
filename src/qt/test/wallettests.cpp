...
void TestGUI()
{
    ...
    uint256 txid1 = SendCoins(*wallet.get(), sendCoinsDialog, CKeyID(), 20 * CENT, false /* rbf */);
    uint256 txid2 = SendCoins(*wallet.get(), sendCoinsDialog, CKeyID(), 50 * CENT, true /* rbf */);
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: namecoin:")) != -1);
