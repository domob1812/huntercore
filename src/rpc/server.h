...
extern UniValue getNameInfo(const valtype& name, const valtype& value, bool dead, const COutPoint& outp, const CScript& addr);
extern UniValue getNameInfo(const valtype& name, const CNameData& data);
extern void addHeightInfo(int height, UniValue& data);
