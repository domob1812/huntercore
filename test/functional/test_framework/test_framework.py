...
class BitcoinTestMetaClass(type):
    ...
    def __new__(cls, clsname, bases, dct):
        if not clsname in ['BitcoinTestFramework', 'NameTestFramework', 'GameTestFramework']:
...
class BitcoinTestFramework(metaclass=BitcoinTestMetaClass):
    ...
    def main(self):
        ...
        parser.add_option("--usecli", dest="usecli", default=False, action="store_true",
                          help="use huntercoin-cli instead of RPC for all commands")
        ...
        self.options.bitcoind = os.getenv("BITCOIND", default=config["environment"]["BUILDDIR"] + '/src/huntercoind' + config["environment"]["EXEEXT"])
        self.options.bitcoincli = os.getenv("BITCOINCLI", default=config["environment"]["BUILDDIR"] + '/src/huntercoin-cli' + config["environment"]["EXEEXT"])
        ...
        if create_cache:
            ...
            for i in range(MAX_NODES):
                for entry in os.listdir(cache_path(i)):
                    if entry not in ['wallets', 'chainstate', 'blocks', 'indexes', 'gamestates']:
